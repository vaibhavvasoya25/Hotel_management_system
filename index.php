        ...
        <nav id="navbar">
            ...
            <div>
                <ul class="item-ul">
                    ...
                    <li class="items"><a href="./Facilities.html">Facilities</a></li>
                    <li cla ss="items"><a href="./Reservation.php">Reservation</a></li>
                    <li class="items"><a href="./photo-gallery.html">Photo gallery</a></li>
